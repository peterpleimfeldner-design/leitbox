...
class custom_completion extends activity_custom_completion {
    ...
    public function get_state(string $rule): int {
        ...
        if ($rule === 'completion_min_cards') {
            // Not in customdata = rule disabled = treat as fulfilled.
            ...
            // Counts cards that were answered correctly at least once (box_number >= 1).
            // A card only reaches Box 1+ if it was rated green at least once.
            // This is the first real quality proof in the Leitner system –
            // as opposed to COUNT(DISTINCT cardid) which also counts red-rated cards.
